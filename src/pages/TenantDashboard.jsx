...
// Lazy load sub-pages
const Maintenance = React.lazy(() => import('./Tenant/Maintenance'));
const Payments = React.lazy(() => import('./Tenant/Payments'));

const TenantOverview = ({ properties, maintenance, payments, stats, refresh }) => {
  ...
  return (
    <DashboardLayout role="tenant" menuItems={menuItems}>
      <React.Suspense fallback={<LoadingSpinner fullScreen />}>
        <Routes>
          <Route index element={<TenantOverview properties={properties} maintenance={maintenance} payments={payments} stats={stats} refresh={refresh} />} />
