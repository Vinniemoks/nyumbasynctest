...
type LVal = Identifier | MemberExpression | RestElement | AssignmentPattern | ArrayPattern | ObjectPattern | OptionalMemberExpression | TSParameterProperty | TSAsExpression | TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression;
...
declare function isVoidPattern(node: Node | null | undefined, opts?: Opts<VoidPattern> | null): node is VoidPattern;
...
declare function isTSTemplateLiteralType(node: Node | null | undefined, opts?: Opts<TSTemplateLiteralType> | null): node is TSTemplateLiteralType;
...
declare function isTSEnumBody(node: Node | null | undefined, opts?: Opts<TSEnumBody> | null): node is TSEnumBody;
...
declare function isFunctionParameter(node: Node | null | undefined, opts?: Opts<FunctionParameter> | null): node is FunctionParameter;
